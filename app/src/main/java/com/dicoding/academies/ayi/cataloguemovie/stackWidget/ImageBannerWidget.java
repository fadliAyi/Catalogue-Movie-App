...
public class ImageBannerWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.dicoding.academies.ayi.cataloguesmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.dicoding.academies.ayi.cataloguemovie.EXTRA_ITEM";
